            ...
            <div className="mobile-logo-area d-lg-none d-flex justify-content-center">
              <div className="mobile-logo-wrap">
                <Link href="/">
                  ...
                  <img alt="image" src="/assets/img/bh-auction-logo.jpeg" height='74px' width='90px' />
            ...
            <ul className="menu-list">
              ...
              >
                ...
                >
                  ...
                  <li className={pathName==="/current-auction"?"active":""}>
              ...
              <li className="menu-item-has-children">
                ...
                <i
                  className={`dropdown-icon ${state.activeMenu === "about" ? "bi bi-dash" : "bi bi-plus"
                    }`}
                  onClick={() => collapseMenu("about")}
                />
                <ul
                  className={`sub-menu ${state.activeMenu === "about" ? "d-block" : ""
                    }`}
                >
